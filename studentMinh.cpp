                    ...
                    if(cur->id == s)
                    {
                        ...
                        cin >>choice2;
                            ...
                            else if (choice2==6)
                            {
                                ...
                                {
                                    cout<<"Day "<<i+1<<": "<<endl;
                                    cin >> cur->daySt[i].dayInWeek ;
                                    cout<<"Time "<<i+1<<": "<<endl;
                                   cin >> cur->daySt[i].time;
...
void deleteCourseStudent1(student *& st) ///done
{
    student * tmp =st;
    while(tmp)
    {
...
void deleteCourseStudent2(student *& st) ///done
{
    student * tmp =st;
    while(tmp)
    {
...
void deleteCourseStudent3(student *& st) ///done
{
    student * tmp =st;
    while(tmp)
    {
